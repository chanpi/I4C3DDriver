========================================================================
    Win32 アプリケーション: I4C3DDriver プロジェクトの概要
========================================================================

この I4C3DDriver アプリケーションは、AppWizard により作成されました。

このファイルには、I4C3DDriver 
...
I4C3DDriver.ico
    ...
    ファイルです。
    このアイコンは、メイン リソース ファイル I4C3DDriver.rc 
    にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン 
    ファイルです。 このアイコンは、メイン リソース ファイル I4C3DDriver.rc 
    にインクルードされます。
